...
- Limited the minimum window opacity to 10% to prevent accidentally making the widget invisible.
- Clamp old saved opacity values below 10% when loading the app.
